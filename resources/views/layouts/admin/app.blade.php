...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('css/datatable/datatable.js') }}"></script>
    ...
    <body class="font-sans antialiased dark:bg-gray-700 dark:text-slate-300">
            ...
            {{-- For Mobile Nav --}}
                ...
                {{-- <div class="w-full md:hidden shadow-gray-300 dark:shadow-gray-800 bg-[#1d508d] shadow-md" x-data="{ isNav: false }">
       ...
       <div class="w-full flex">
            <div class="w-64  hidden md:flex ">
                <div class="w-64 min-h-screen max-h-full  bg-[#1d508d] dark:bg-gray-800 dark:shadow-gray-700 shadow-lg shadow-sky-300 ">
                <a href="/dashboard" class="bg-white" >
                    <p>ClothMatter</p>
                </a>
               <ul class="my-2 text-white">
                ...
                <a href="{{ route('dashboard') }}" class="block mt-1">
                   <li class="pl-4 text-lg py-2 font-semibold hover:bg-blue-300 hover:text-gray-700
                   {{(request()->routeIs('dashboard'))? "bg-[#eb8d02] text-white " : "text-slate-300"}} 
                   transition-colors ease-in-out delay-100">
                       <i class="fa fa-tachometer"></i> &nbsp; Dashboard
                   </li>
                </a>
...
{{--                  
                 <a href="{{route('admin.users.edit')}}" class="block mt-1 ">
                    <li class="pl-4 text-lg py-2 {{(request()->routeIs('admin.users.*'))? "bg-[#eb8d02] text-white " : "text-slate-300"}}  hover:bg-blue-300 hover:text-gray-700 
