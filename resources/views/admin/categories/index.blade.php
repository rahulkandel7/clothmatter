            ...
            <tbody>
                ...
                <tr class="border border-gray-400 ">
                    ...
                    <td class="py-2 h-full items-center px-2 flex">
                        <a > <i class="text-2xl px-2 fa-solid fa-trash text-red-500 hover:text-red-600 " onclick="showdelete({{$category->id}})">D</i> </a>

                        <a href="{{route('admin.categories.edit',$category->id)}}"><i class="text-2xl px-2 fa-solid fa-trash text-indigo-500 hover:text-indigo-600 " >E</i> </a>
